...
export abstract class BaseTabsComponent<T extends BaseEntityInterface> implements OnDestroy, OnInit {
  ...
  protected constructor(@Inject('entityFormFacade') protected entityFormFacade: IEntityFormFacade<T>, protected activeTabService: ActiveTabService, protected route: ActivatedRoute) {
