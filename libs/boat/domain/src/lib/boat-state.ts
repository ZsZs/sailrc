...
export const { initialState, facade: BoatFacadeBase } = buildFeatureState( Boat, DOMAIN_NAME, domainSelector );
...
export const getBoatById = ( id: number ) => createSelector( getBoatDomainState, state => state.boat.entities[id] );
