...
export class RaceParticipantTabsComponent extends BaseTabsComponent<Participant> implements OnInit {
  constructor(protected participantFeatureFacade: RaceParticipantFeatureFacade, protected activeTabService: ActiveTabService, protected route: ActivatedRoute) {
